...
button_register = tk.Button(root, text="Sign up", command=register_user, relief="flat", borderwidth=0, width=10, height=2, justify='center', bg='#F5F2EB', activebackground='white', font="Times, 12")
