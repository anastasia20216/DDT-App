...
def main():
    ...
    def unsave_recipe(rep_id):
        ...
        try:
            ...
            print(f"Database error(unsave): {e}")
    ...
    save_rep = tk.Button(root, text="Save Recipe  ", image=heart, compound=RIGHT, state=tk.NORMAL, relief="flat", borderwidth=0, font=("Helvetica", 14) , justify='center', padx=10, pady=10, command=lambda: save_recipe(received_id))
