...
#takes keywrod and searchs all parts of the database for a match of keyword and display error if no input
def search_database():
    global keyword
    keyword = entry.get()
...
global buttons
buttons = []
#takes the results and displays the title of each recipe on buttons that opens the recipe details from database
